...
\newcommand{\Author}{LAURA ANDREA RODRIGUEZ RODRIGUEZ}
\newcommand{\MainTitle}{Flik: A Back-in-Time debugger for Reinforcement Learning Systems}
...
\publishers{%
  ...
  \begin{tabularx}{1.01\linewidth}{Xr}
    ...
    Prof. Nicolas \textsc{CARDOZO} (Promotor) & 
     Universidad de los Andes, Colombia\\
    Prof. Ivana \textsc{DUSPARIC} \textsc{Reviewer 1} & 
     Trinity College Dublin, Ireland\\
    Prof. Mario \textsc{LINARES} \textsc{Reviewer 2} & 
    Universidad de los Andes, Colombia\\
  \end{tabularx}}
